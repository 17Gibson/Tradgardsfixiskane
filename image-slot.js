...
(() => {
  ...
  const stylesheet =
    ...
    '  background:rgba(0,0,0,.62);color:#fff;font:600 11px/1 system-ui,-apple-system,sans-serif;' +
    '  backdrop-filter:blur(6px);box-shadow:0 2px 8px rgba(0,0,0,.25)}' +
  ...
  class ImageSlot extends HTMLElement {
    ...
    constructor() {
      ...
      root.innerHTML =
        ...
        '    <div class="cap"></div>' +
        '    <div class="sub">eller <u>bläddra bland filer</u></div></div>' +
        ...
        '</div>' +
        '<div class="ctl"><button data-act="replace" title="Byt bild">Byt bild</button>' +
        '  <button data-act="clear" title="Ta bort bild">Ta bort</button></div>' +
